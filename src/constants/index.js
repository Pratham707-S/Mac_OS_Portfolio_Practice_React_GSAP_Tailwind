  ...
  children: [
      ...
      children: [
        {
          ...
          description: [
            "KP STORE is a modern Apple-grade e-commerce shopping experience built from scratch.",
            "Features seamless cart management, responsive product showcases, fluid animations, and zero-AI pure handwritten React code.",
            "Delivers lightning-fast checkout flow and pixel-perfect macOS typography.",
          ],
        },
        {
          id: 2,
    ...
    // ▶ Project 2: REDEFINE GAMING
    {
      ...
      children: [
        {
          id: 1,
          name: "Redefine Gaming Project.txt",
          icon: "/images/txt.png",
          kind: "file",
          fileType: "txt",
          ...
          description: [
            "REDEFINE GAMING is an award-winning immersive metagame web experience.",
            "Engineered with cutting-edge GSAP scroll animations, high-octane 3D graphics, and dynamic sound effects.",
            "Optimized for 60fps buttery-smooth rendering across desktop and mobile browsers.",
          ],
        },
        {
          id: 2,
