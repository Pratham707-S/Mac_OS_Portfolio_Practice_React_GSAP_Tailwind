  ...
  return (
    <div className="w-full flex flex-col bg-white dark:bg-[#1e1e1e] text-gray-800 dark:text-gray-100 rounded-xl shadow-2xl overflow-hidden font-sans select-none">
      ...
      <div className="flex min-h-[440px] max-h-[520px]">
        {/* Left Sidebar */}
        <aside className="w-48 flex-none bg-[#f8f9fa] dark:bg-[#252528] border-r border-gray-200 dark:border-[#3a3a3c] p-3 flex flex-col">
              ...
              {filteredPhotos.map((photo, index) => {
                ...
                return (
                  <div
                    ...
                    className={`relative group rounded-xl overflow-hidden shadow-sm hover:shadow-md cursor-pointer border border-black/5 dark:border-white/10 bg-gray-100 dark:bg-zinc-800 transition-transform duration-300 hover:scale-[1.01] ${
      ...
      {/* Lightbox Modal for Selected Photo / Video */}
      {selectedPhoto && (
        <div
        ...
        >
          <div
            className="relative max-w-3xl max-h-[85vh] bg-[#1e1e1e] rounded-2xl overflow-hidden shadow-2xl border border-white/20 p-2"
