    ...
    >
      ...
      <div className="w-[160px] bg-white/[0.04] border-r border-white/10 p-3 flex flex-col justify-between shrink-0">
        <div className="flex flex-col gap-1">
          ...
          {[
            { id: "apple_id", label: "Overview", icon: "👤" },
            ...
            <button
              ...
              className={`w-full text-left px-2.5 py-1.5 rounded-xl text-[12px] font-medium flex items-center gap-2 transition-all ${
                activeTab === tab.id
              ...
              <div className="flex items-center gap-3.5">
                <div className="relative">
                  <img
                    ...
                    className="w-14 h-14 rounded-full border-2 border-white/40 shadow-lg object-cover !filter-none !opacity-100"
                  />
                ...
                <div>
                  ...
                  <span className="inline-block mt-1 text-[10px] font-medium bg-white/15 text-white/90 px-2 py-0.5 rounded-full border border-white/10">
