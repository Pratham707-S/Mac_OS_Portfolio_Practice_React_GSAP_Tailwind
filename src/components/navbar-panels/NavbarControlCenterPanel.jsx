        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div
              ...
              title="Stage Manager"
              className={`border rounded-2xl p-2 flex flex-col items-center justify-center gap-1 cursor-pointer transition-all ${
                stageManager
                  ? "bg-white/25 border-white/30"
                  : "bg-white/[0.08] hover:bg-white/[0.12] border-white/10"
              }`}
            >
              <div className="w-5 h-5 rounded-md flex items-center justify-center text-white/80">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <rect width="18" height="18" x="3" y="3" rx="3" />
                  <path d="M3 9h4M3 15h4" />
                </svg>
              </div>
              <span className="text-[9.5px] font-medium text-white/80 leading-tight">Stage</span>
            </div>
            ...
            >
              <div className="w-5 h-5 rounded-md flex items-center justify-center text-white/80">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <path d="m14 15 4 4M22 19h-8M18 15v4" />
                </svg>
              </div>
              <span className="text-[9.5px] font-medium text-white/80 leading-tight">Mirror</span>
            </div>
          </div>
        </div>
      </div>
